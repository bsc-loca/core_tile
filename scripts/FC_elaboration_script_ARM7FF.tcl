...
lappend search_path $std_cell_lef_path/sch300mcpp64_base_svt_c11/r14p0/lef/
	...
	lappend search_path "$RTL_path/core/sargantana/tb/tb_register"
	lappend search_path "$RTL_path/core/sargantana/tb/tb_register_struct"
	lappend search_path "$RTL_path/core/sargantana/tb/tb_top"
	lappend search_path "$RTL_path/core/sargantana/tb/tb_generic"
	...
	lappend search_path "$RTL_path/core/sargantana/rtl/datapath/tb/tb_datapath"
	lappend search_path "$RTL_path/core/sargantana/rtl/datapath/rtl/exe_stage/tb/tb_branch_unit"
	lappend search_path "$RTL_path/core/sargantana/rtl/datapath/rtl/exe_stage/tb/tb_bpm"
	lappend search_path "$RTL_path/core/sargantana/rtl/datapath/rtl/exe_stage/tb/tb_fpu"
	lappend search_path "$RTL_path/core/sargantana/rtl/datapath/rtl/exe_stage/tb/tb_mul_unit"
	lappend search_path "$RTL_path/core/sargantana/rtl/datapath/rtl/exe_stage/tb/tb_alu"
	lappend search_path "$RTL_path/core/sargantana/rtl/datapath/rtl/exe_stage/tb/tb_div_unit"
	lappend search_path "$RTL_path/core/sargantana/rtl/datapath/rtl/exe_stage/tb/tb_ls_queue"
	lappend search_path "$RTL_path/core/sargantana/rtl/datapath/rtl/exe_stage/tb/tb_simd_vbpm"
	lappend search_path "$RTL_path/core/sargantana/rtl/datapath/rtl/exe_stage/tb/tb_top"
	lappend search_path "$RTL_path/core/sargantana/rtl/datapath/rtl/exe_stage/tb/tb_vbpm"
	lappend search_path "$RTL_path/core/sargantana/rtl/datapath/rtl/exe_stage/tb/tb_mem_unit"
	...
	lappend search_path "$RTL_path/core/sargantana/rtl/datapath/rtl/if_stage_1/tb/tb_if_stage"
	lappend search_path "$RTL_path/core/sargantana/rtl/datapath/rtl/if_stage_1/tb/tb_branch_predictor"
	lappend search_path "$RTL_path/core/sargantana/rtl/datapath/rtl/if_stage_1/rtl"
	lappend search_path "$RTL_path/core/sargantana/rtl/datapath/rtl/rr_stage/tb/tb_regfile"
	lappend search_path "$RTL_path/core/sargantana/rtl/datapath/rtl/rr_stage/rtl"
	lappend search_path "$RTL_path/core/sargantana/rtl/datapath/rtl/wb_stage/tb/tb_graduation_list"
	lappend search_path "$RTL_path/core/sargantana/rtl/datapath/rtl/wb_stage/rtl"
	lappend search_path "$RTL_path/core/sargantana/rtl/datapath/rtl/ir_stage/tb/tb_free_list"
	lappend search_path "$RTL_path/core/sargantana/rtl/datapath/rtl/ir_stage/tb/tb_rename"
	lappend search_path "$RTL_path/core/sargantana/rtl/datapath/rtl/ir_stage/rtl"
	lappend search_path "$RTL_path/core/sargantana/rtl/datapath/rtl/if_stage_2/tb/tb_if_stage"
	lappend search_path "$RTL_path/core/sargantana/rtl/datapath/rtl/if_stage_2/tb/tb_branch_predictor"
	lappend search_path "$RTL_path/core/sargantana/rtl/datapath/rtl/if_stage_2/rtl"
	lappend search_path "$RTL_path/core/sargantana/rtl/datapath/rtl/id_stage/tb/tb_decoder"
	lappend search_path "$RTL_path/core/sargantana/rtl/datapath/rtl/id_stage/rtl"
	lappend search_path "$RTL_path/core/sargantana/rtl/control_unit/tb/tb_control_unit"
	lappend search_path "$RTL_path/core/sargantana/rtl/control_unit/rtl"
	lappend search_path "$RTL_path/icache/tb"
	...
	lappend search_path "$RTL_path/common_cells/test"
	lappend search_path "$RTL_path/common_cells/formal"
	lappend search_path "$RTL_path/common_cells/src"
	lappend search_path "$RTL_path/interface_dcache/tb/tb_interface_dcache"
	lappend search_path "$RTL_path/interface_dcache/rtl"
	lappend search_path "$RTL_path/interface_icache/tb/tb_icache_interface"
